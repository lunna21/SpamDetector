...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_START_ANALYSIS = 3,             /* START_ANALYSIS  */
  YYSYMBOL_END_ANALYSIS = 4,               /* END_ANALYSIS  */
  YYSYMBOL_SPAM_PATTERN = 5,               /* SPAM_PATTERN  */
  YYSYMBOL_WORD_TOKEN = 6,                 /* WORD_TOKEN  */
  YYSYMBOL_7_ = 7,                         /* '+'  */
  YYSYMBOL_8_ = 8,                         /* '-'  */
  YYSYMBOL_9_ = 9,                         /* '*'  */
  YYSYMBOL_10_ = 10,                       /* '/'  */
  ...
  YYSYMBOL_message = 20,                   /* message  */
  YYSYMBOL_message_part = 21,              /* message_part  */
  YYSYMBOL_content = 22                    /* content  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "START_ANALYSIS",
  "END_ANALYSIS", "SPAM_PATTERN", "WORD_TOKEN", "'+'", "'-'", "'*'", "'/'",
  "'.'", "','", "';'", "':'", "'!'", "'?'", "'('", "')'", "$accept",
  "message", "message_part", "content", YY_NULLPTR
};
...
{
       6,     7,     8,     2,     0,     0,     3,     9,    10,    11,
      12,    13,    14,    15,    16
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,     0,    -1,    -1,     3,    11,    12,    13,
      14,    15,    16,    17,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* content: content SPAM_PATTERN  */
#line 58 "src/spam_parser.y"
         { 
             /* Cada patrón de spam detectado incrementa el contador */
             current_result.spam_found = 1;
         }
#line 1106 "spam_parser.tab.c"
    break;

  case 7: /* content: content WORD_TOKEN  */
#line 63 "src/spam_parser.y"
         { 
             /* Registrar palabras para posible análisis estadístico */
             free((yyvsp[0].text)); 
         }
#line 1115 "spam_parser.tab.c"
    break;


#line 1119 "spam_parser.tab.c"
